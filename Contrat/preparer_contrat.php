...
";
    ...
    //     'marginLeft' => Converter::cmToTwip(0.1),
    //     'marginRight' => Converter::cmToTwip(0.1),
    // ]);
    ...
    $outputPath = './' . $nom . '_' . $prenom . '_contract.docx';
    $phpWord->save($outputPath, 'Word2007');

    $contractName = "{$nom}_{$prenom}_contract.docx";

    // Update the contract name in the users table
