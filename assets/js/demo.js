...
//Chart
var ctx = document.getElementById('statisticsChart').getContext('2d');X
		...
		datasets: [
			{
				...
				pointBackgroundColor: 'rgba(212, 175, 55, 0.6)',
				pointRadius: 0,
				backgroundColor: 'rgb(255, 247, 212 , 0,4 )',
				legendColor: '#d4af37',
				fill: true,
				borderWidth: 2,
			...
			{
				label: "New Visitors",
				borderColor: '#8b4513', // Dark color
				pointBackgroundColor: 'rgba(139, 69, 19, 0.6)',
				pointRadius: 0,
				backgroundColor: 'rgb(255, 217, 90, 0.4)',
				legendColor: '#8b4513',
				fill: true,
				borderWidth: 2,
			...
			{
				label: "Active Users",
				borderColor: '#ff8c00', // Darker gold color
